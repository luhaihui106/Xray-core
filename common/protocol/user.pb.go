...
type User struct {
	...
	SpeedLimitUpMbps   uint32 `protobuf:"varint,4,opt,name=speed_limit_up_mbps,json=speedLimitUpMbps,proto3" json:"speed_limit_up_mbps,omitempty"`
	SpeedLimitDownMbps uint32 `protobuf:"varint,5,opt,name=speed_limit_down_mbps,json=speedLimitDownMbps,proto3" json:"speed_limit_down_mbps,omitempty"`
...
func (x *User) GetSpeedLimitUpMbps() uint32 {
	if x != nil {
...
func (x *User) GetSpeedLimitDownMbps() uint32 {
	if x != nil {
...
const file_common_protocol_user_proto_rawDesc = "" +
	...
	"\x13speed_limit_up_mbps\x18\x04 \x01(\rR\x10speedLimitUpMbps\x121\n" +
	"\x15speed_limit_down_mbps\x18\x05 \x01(\rR\x12speedLimitDownMbpsB^\n" +
